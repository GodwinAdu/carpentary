...
export function AdvancedChatPanel({ isOpen, onClose }: AdvancedChatPanelProps) {
    const {
        messages,
        sendMessage,
        currentSocketId,
    ...
    return (
        <div className="absolute right-4 top-32 z-10 w-96">
            <Card className="p-0 overflow-hidden shadow-lg border-2">
                {/* Header */}
