...
const RoleSchema = z.object({
  ...
  permissions: z.object({
    ...
    activateStaff: z.boolean(),
    deactivateStaff: z.boolean(),
    resetPasswordStaff: z.boolean(),
    sendInvite: z.boolean(),
    viewActivityLog: z.boolean(),
    addDepartment: z.boolean(),
    viewDepartment: z.boolean(),
    editDepartment: z.boolean(),
    deleteDepartment: z.boolean(),
    manageDepartment: z.boolean(),
    addRole: z.boolean(),
    viewRole: z.boolean(),
    editRole: z.boolean(),
...
const permissionDescriptions = {
  ...
  addStaff: "Create new staff records",
  viewStaff: "View staff information",
  editStaff: "Modify staff records",
  deleteStaff: "Remove staff records",
  manageStaff: "Full staff management access",
  activateStaff: "Activate staff accounts",
  resetPasswordStaff: "Reset staff passwords",
  sendInvite: "Send staff invites",
  viewActivityLog: "View staff activity logs",
  addDepartment: "Create new departments",
  viewDepartment: "View department details",
  editDepartment: "Modify department information",
  deleteDepartment: "Remove departments",
  manageDepartment: "Full department management access",
